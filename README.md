...
한글·수학·영어 놀이 1,000문제와 별이 꾸미기 사이트입니다. 기본 놀이 500문제와 7살 도전 500문제를 따로 고를 수 있습니다. 각 난이도는 100단계이며, 한 단계마다 5문제씩 놀이합니다. 회원 가입은 필요하지 않습니다.
...
별, 끝낸 단계, 선택한 난이도, 옷과 배경 선택은 이 브라우저에 저장됩니다. 이전 300문제의 완료 기록도 이어집니다. 음악은 첫 화면 터치 후 시작하며 3곡이 번갈아 나옵니다. 정답을 골라도 다른 보기를 눌러볼 수 있고, 별은 문제당 한 번만 받습니다. 정답·재시도·단계 완료·꾸미기에 각기 다른 효과음이 나옵니다. 오른쪽 위 스피커로 음악·음성·효과음을 한꺼번에 끄거나 켤 수 있습니다. 음성, 그림, 글꼴은 사이트에 포함되어 있어 외부 서비스가 필요하지 않습니다.
