...
별, 끝낸 단계, 선택한 난이도, 옷과 배경 선택은 이 브라우저에 저장됩니다. 기존 진행 기록도 이어집니다. 각 과목의 단계는 앞 단계를 마치고 별을 모으면 열립니다. 7살 도전은 별 75개와 기본 놀이 10단계 완료, 8살 도전은 별 200개와 7살 도전 15단계 완료가 필요합니다. 두 난이도 조건의 단계 완료는 어느 한 과목에서 달성하면 됩니다. 음악은 첫 화면 터치 후 시작하며 3곡이 번갈아 나옵니다. 정답을 골라도 다른 보기를 눌러볼 수 있고, 별은 문제당 한 번만 받습니다. 정답·재시도·단계 완료·꾸미기에 각기 다른 효과음이 나옵니다. 오른쪽 위 스피커로 음악·음성·효과음을 한꺼번에 끄거나 켤 수 있습니다. 음성, 그림, 글꼴은 사이트에 포함되어 있어 외부 서비스가 필요하지 않습니다.
